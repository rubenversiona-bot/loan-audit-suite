...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pericia Hipotecaria — LegalTech" },
      { property: "og:description", content: "Auditoría hipotecaria con autocarga de Euríbor e IRPH del Banco de España." },
